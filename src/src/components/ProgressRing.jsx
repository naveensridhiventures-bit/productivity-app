...
export default function ProgressRing({ ratio, pillarsDone, dayLabel, isComplete }) {
  const offset = CIRC * (1 - ratio)

  return (
    <div className={`ring-wrap ${isComplete ? 'is-complete' : ''}`}>
      <svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`}>
        ...
        <circle
          ...
          r={R}
          fill="none"
          stroke={isComplete ? 'var(--gold)' : 'var(--moss)'}
          strokeWidth={STROKE}
          strokeLinecap="round"
